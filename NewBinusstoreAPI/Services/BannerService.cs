...
namespace NewBinusstoreAPI.Services
{
    ...
    {
        public BannerService(ILogger<BaseService> logger) : base(logger)
        {
        }
        ...
        public IActionResult Get()
        {
            try
            {
                ...
                if (Token != "")
                {
                    ...
                    {
                        objJSON.Data = Helper.BannerHelper.Get((ValidTokenModel)processToken.Data);
                    }
                    else
                    {
        ...
        public IActionResult GetSingle(string ID)
        {
            try
            {
                ...
                if (Token != "")
                {
                    ...
                    {
                        objJSON.Data = Helper.BannerHelper.GetSingle((ValidTokenModel)processToken.Data, ID);
