...
namespace NewBinusstoreAPI.Services
{
    [ApiController]
    [Route("SiCepatPickup")]
    public class SiCepatPickupService : BaseService
    {
        public SiCepatPickupService(ILogger<BaseService> logger) : base(logger)
        {
        }
        ...
        public IActionResult Get()
        {
            try
            {
                ...
                if (Token != "")
                {
                    ...
                    {
                        objJSON.Data = Helper.SiCepatPickupHelper.Get((ValidTokenModel)processToken.Data);
